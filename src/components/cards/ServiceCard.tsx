...
export function ServiceCard({ service }: { service: Service }) {
  return (
    <div className="bg-surface-container-lowest p-8 rounded-xl shadow-[0_12px_40px_rgba(28,28,25,0.06)] group hover:-translate-y-1 transition-transform duration-300">
