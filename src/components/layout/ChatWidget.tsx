...
export function ChatWidget() {
  ...
  return (
    <>
      ...
      <a href={contact.messenger} target="_blank" rel="noopener" aria-label="Messenger" className="fixed bottom-[96px] right-6 z-[9999] w-[60px] h-[60px] rounded-full bg-white border-[3px] border-[#0084FF] shadow-[0_4px_20px_rgba(0,132,255,0.35)] flex items-center justify-center hover:scale-110 transition-transform">
